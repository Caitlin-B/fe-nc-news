...
class InfiniteScroller extends Component {
  ...
  componentDidUpdate(prevProps) {
    ...
    this.setState({data:[], page: 1}, () => {this.fetchData(this.props.topic)})}
  }
  ...
  filterOptions = (event) => {
    ...
    this.setState({data:[], page: 1, sort_by, order}, () => {this.fetchData(this.props.topic)})
  }
  ...
  fetchData = (topic) => {
    ...
    return api.fetchArticles({p: page, sort_by, order, topic}).then(({articles})=> {
      this.setState((currentState) => {
        return { data: currentState.data.concat(articles), isLoading: false, page: currentState.page + 1 }
      });
    })
  }
